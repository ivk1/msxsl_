...
const MSXMLInfo::StaticInfo MSXMLInfo::s_staticInfo60 =
{
	...
	&__uuidof(XSLTemplate60),
	L"MSXML6.XSLTemplate.6.0",

	&__uuidof(DOMDocument60),
	L"MSXML6.DOMDocument.6.0",

	&__uuidof(FreeThreadedDOMDocument60),
	L"MSXML6.FreeThreadedDOMDocument.6.0",
};
...
MSXMLInfo::FindMSXMLInfo(Version version)
{
	...
	case VERSION_60:
		memcpy(&_staticInfo, &s_staticInfo60, sizeof(StaticInfo));
		break;
...
MSXMLInfo::FindLatestMSXMLInfo()
{
	...
	memcpy(&_staticInfo, *s_rgpStaticInfo, sizeof(StaticInfo));  //take the first entry (6.0) as default
//	return hr;
